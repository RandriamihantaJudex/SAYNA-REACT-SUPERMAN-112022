...
import "./eshopStyle.css"
import { BarBas } from "./Header";
...
const couleur ={
    ...
    const changementBox=(e)=>{
        if (e.target.style.backgroundColor==='red') {
            e.target.style.backgroundColor='black'
            e.target.style.border='solid white 1px'
        }
        else{
                        ...
                        <div key={item} className="componentCategory">
                            <div className="checkDiv">
                                <input
                                    ...
                                    id={"category"+item}
                                />
                                 <label htmlFor={"category"+item} className="labelRadio" onClick={e=>changementBox(e)}><div></div></label> 
...
function Eshop() {
    ...
    return <div className="Eshop">
        <Navbar />
        <Accueil><h1>ENVIE D'UN SLIP JAUNE?</h1></Accueil>
        <BarBas />
        <div className="cartDiv"> <img onClick={() => lien()} src="../../../../assets/icones/icone_1.png" alt="cart" /> </div>
        <div className="titleFilter"> Filtre </div>
        <div className="elementEshop"></div>
        <FiltreProvider className='dfd'>
          <Filtre />
          <ProductList />
        </FiltreProvider>
    </div>
